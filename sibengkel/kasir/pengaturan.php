...
$sql = "SELECT * FROM karyawan WHERE id_karyawan ='" . $sess_kasirid . "'";
						...
						<div class="panel-body">
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="hidden" name="password_old2" value="<?php echo $data['pass_karyawan'] ?>">
									<input type="hidden" name="id_pengguna" value="<?php echo $data['id_karyawan'] ?>">
								</div>
							</div>
							<div class="form-group">
