...
if (isset($_GET['js'])) {
	$sql = "SELECT * FROM jasa_servis WHERE id='" . $_GET['js'] . "'";
	$ress = mysqli_query($conn, $sql);
	$data = mysqli_fetch_array($ress);
}
// deskripsi halaman
$pagedesc = "Jasa Servis";
$menuparent = "jasa_servis";
...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Jasa Servis</h1>
			</div><!-- /.col-lg-12 -->
		</div><!-- /.row -->
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="jenis" class="form-control" placeholder="Jenis" value="<?php echo $data['jenis'] ?>" required>
									<input type="hidden" name="id" class="form-control" placeholder="Jenis" value="<?php echo $data['id'] ?>" required>
								</div>
							</div>
							<div class="form-group">
