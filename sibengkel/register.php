						...
						<div class="col-lg-12">
							<div class="panel panel-default">
								<div class="panel-body">
									<form action="pelanggan_insert.php" method="post" enctype="multipart/form-data">
										<div class="form-group">
											<input type="text" maxlength="16" class="form-control" name="ktp" placeholder="KTP" required>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<input type="text" maxlength="12" class="form-control" name="no_hp" placeholder="No HP" required>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<input type="file" id="fileToUpload" name="fileToUpload" placeholder="Upload Foto">
										</div>
										<div class="form-group">
