							...
							<tbody>
								...
								while ($data = mysqli_fetch_array($ress)) {
									...
									echo '<td class="text-center">
													  <a href="barang_edit.php?brg=' . $data['kode'] . '" class="btn btn-warning btn-xs">Edit</a>'; ?>
									<a href="barang_hapus.php?brg=<?php echo $data['kode']; ?>" onclick="return confirm('Apakah anda yakin akan menghapus <?php echo $data['nama']; ?>?');" class="btn btn-danger btn-xs">Hapus</a></td>
								<?php
									echo '</td>';
									echo '</tr>';
									$i++;
