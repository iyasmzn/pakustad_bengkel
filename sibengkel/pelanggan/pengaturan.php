<?php
	...
	$sql = "SELECT * FROM pelanggan WHERE id_pelanggan ='". $sess_pelangganid ."'";
								...
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-sm-4">
											...
											<input type="hidden" name="password_old2" value="<?php echo $data['pass_pelanggan'] ?>">
											<input type="hidden" name="id_pengguna" value="<?php echo $data['id_pelanggan'] ?>">
										</div>
									</div>
									<div class="form-group">
