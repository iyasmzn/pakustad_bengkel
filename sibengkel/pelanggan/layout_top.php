			...
			<ul class="nav navbar-top-links navbar-right">
				<li class="dropdown dropdown-right">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">
						<img src="../foto/<?php echo $sess_pelangganfoto; ?>" width="20px" height="20px" padding="0px">&nbsp;&nbsp;<?php echo ucfirst($sess_pelangganname); ?>&nbsp;<i class="fa fa-caret-down"></i>
					</a>
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<ul class="nav nav-second-level">
							...
							if ($pagedesc == "Riwayat") {
								echo '<li><a href="reservation.php" class="active">Riwayat</a></li>';
							} else {
								echo '<li><a href="reservation.php">Riwayat</a></li>';
							}
							?>
						</ul>
						</li>
