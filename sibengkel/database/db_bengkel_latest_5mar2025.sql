...
DROP DATABASE IF EXISTS `db_bengkel`;
CREATE DATABASE IF NOT EXISTS `db_bengkel` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `db_bengkel`;

-- Dumping structure for table db_bengkel.admin
...
-- Dumping data for table db_bengkel.admin: ~1 rows (approximately)
...
-- Dumping structure for table db_bengkel.barangjasa
...
-- Dumping data for table db_bengkel.barangjasa: ~3 rows (approximately)
...
-- Dumping structure for table db_bengkel.karyawan
...
-- Dumping data for table db_bengkel.karyawan: ~1 rows (approximately)
...
-- Dumping structure for table db_bengkel.kasir
...
-- Dumping data for table db_bengkel.kasir: ~1 rows (approximately)
...
-- Dumping structure for table db_bengkel.kendaraan
...
-- Dumping data for table db_bengkel.kendaraan: ~2 rows (approximately)
...
-- Dumping structure for table db_bengkel.konsumen
...
-- Dumping data for table db_bengkel.konsumen: ~2 rows (approximately)
INSERT INTO `konsumen` (`id_kon`, `nama_kon`, `telp_kon`, `alamat_kon`) VALUES
	(0, 'Umum', '0', '-'),
	(3, 'Test Konsumen', '012391839', 'Bekasi');

-- Dumping structure for table db_bengkel.pelanggan
...
-- Dumping data for table db_bengkel.pelanggan: ~2 rows (approximately)
...
-- Dumping structure for table db_bengkel.supplier
...
-- Dumping data for table db_bengkel.supplier: ~2 rows (approximately)
...
-- Dumping structure for table db_bengkel.tmp_trx
...
-- Dumping data for table db_bengkel.tmp_trx: ~7 rows (approximately)
...
-- Dumping structure for table db_bengkel.trx
...
-- Dumping data for table db_bengkel.trx: ~6 rows (approximately)
...
-- Dumping structure for table db_bengkel.trxbarang
...
-- Dumping data for table db_bengkel.trxbarang: ~3 rows (approximately)
