...
CREATE DATABASE IF NOT EXISTS `pakustad_sibengkel` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
-- Dumping data for table pakustad_sibengkel.admin: ~0 rows (approximately)
...
-- Dumping structure for table pakustad_sibengkel.jasa_servis
...
-- Dumping data for table pakustad_sibengkel.jasa_servis: ~6 rows (approximately)
...
-- Dumping data for table pakustad_sibengkel.karyawan: ~0 rows (approximately)
...
-- Dumping data for table pakustad_sibengkel.kasir: ~0 rows (approximately)
...
-- Dumping structure for table pakustad_sibengkel.reservations
...
-- Dumping data for table pakustad_sibengkel.reservations: ~0 rows (approximately)
...
-- Dumping structure for table pakustad_sibengkel.sparepart
...
-- Dumping data for table pakustad_sibengkel.sparepart: ~0 rows (approximately)
